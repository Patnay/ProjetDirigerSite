...
<main>
  ...
  <footer>ELDEN RING &trade; &amp; &copy;2022 BANDAI NAMCO Entertainment Inc./ &copy;2022 FromSoftware, Inc.</footer>
...
toggleBtn.addEventListener("click", () => {
    ...
    if (musicOn) {
        music.play();
        toggleBtn.src = "image/sonOnIndex.jpg";
    } else {
        music.pause();
        toggleBtn.src = "image/sonOffIndex.jpg";
    }
});
</script>
</main>
