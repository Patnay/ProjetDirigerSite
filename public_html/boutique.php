        ...
        <aside class="filters">
            ...
            <form method="get" action="boutique.php">
                ...
                <div class="filter-block">
                    <label><span id="secret4">Catégories</label>
                ...
                <div class="filter-block">
                    <label><span id="secretGamble">Prix maximum</label>
                ...
                <div class="filter-block">
                    <label><span id="secretMad">Étoiles maximum</label>
...
<script>
    document.getElementById("secret4").addEventListener("click", () => {
    window.location.href = "connect4_complete.html";
});
document.getElementById("secretGamble").addEventListener("click", () => {
    window.location.href = "roulette_complete.html";});
    document.getElementById("secretMad").addEventListener("click", () => {
